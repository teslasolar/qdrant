#!/usr/bin/env python3
"""
Download GPU-optimized AI video models
For RTX 4070 Ti SUPER with 16GB VRAM
"""
...
# Create download script without Unicode characters
download_script = """
import os
...
with open("_download_models_temp.py", "w", encoding='utf-8') as f:
    f.write(download_script)

print("\n[DOWNLOAD] Starting model downloads...")
subprocess.run([sys.executable, "_download_models_temp.py"])

print("\n[DONE] Model download process completed!")